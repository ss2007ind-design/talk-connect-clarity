...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SocialSync — Real-time social translator for autistic communication" },
      { property: "og:description", content: "SocialSync helps autistic users navigate conversations with live mood detection, reply suggestions, and chat screenshot decoding." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "SocialSync — Real-time social translator for autistic communication" },
      { name: "twitter:description", content: "SocialSync helps autistic users navigate conversations with live mood detection, reply suggestions, and chat screenshot decoding." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bcaa3d21-9b7a-422c-9d47-1eefa8c4e9b8/id-preview-e5030e56--0e0b37ea-e5be-401c-9c1d-d8232b552fc8.lovable.app-1777205442957.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/bcaa3d21-9b7a-422c-9d47-1eefa8c4e9b8/id-preview-e5030e56--0e0b37ea-e5be-401c-9c1d-d8232b552fc8.lovable.app-1777205442957.png" },
